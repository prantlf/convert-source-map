...
test('\nresolving a /*# sourceMappingURL=data:application/json,... */ style comment inside a given css content (encoded with encodeURIComponent)', function(t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-inline-encode-uri-component.css', 'utf8')
...
test('\nresolving a /*# sourceMappingURL=data:application/json,... */ style comment inside a given css content (encoded with encodeURI)', function(t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-inline-encode-uri.css', 'utf8')
  var conv = convert.fromSource(css)
  var sm = conv.toObject()
